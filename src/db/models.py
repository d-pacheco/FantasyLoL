...
class FantasyLeagueScoringSettingModel(Base):  # type: ignore
    ...
    penta_kill = Column(Float, nullable=False)
    match_win = Column(Float, nullable=False)
    match_sweep = Column(Float, nullable=False)
    dragon = Column(Float, nullable=False)
    elder_dragon = Column(Float, nullable=False)
    baron = Column(Float, nullable=False)
    tower = Column(Float, nullable=False)
    inhibitor = Column(Float, nullable=False)
    soul = Column(Float, nullable=False)
