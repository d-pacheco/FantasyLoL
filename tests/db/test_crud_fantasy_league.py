...
class TestCrudFantasyLeague(FantasyLolTestBase):
    ...
    def test_create_fantasy_league(self):
        ...
        # Act and Assert
        fantasy_league_before_create = crud.get_fantasy_league_by_id(fantasy_league.id)
        self.assertIsNone(fantasy_league_before_create)
        crud.create_fantasy_league(fantasy_league)
        fantasy_league_after_create = crud.get_fantasy_league_by_id(fantasy_league.id)
    ...
    def test_get_fantasy_league_by_id(self):
        ...
        # Act and Assert
        self.assertEqual(fantasy_league, crud.get_fantasy_league_by_id(fantasy_league.id))
        self.assertIsNone(crud.get_fantasy_league_by_id(FantasyLeagueID("123")))
    ...
    def test_put_fantasy_league_scoring_settings(self):
        ...
        # Act and Assert
        scoring_settings_before_create = crud.get_fantasy_league_scoring_settings_by_id(
        ...
        scoring_settings_after_create = crud.get_fantasy_league_scoring_settings_by_id(
            scoring_settings.fantasy_league_id
        )
        self.assertEqual(scoring_settings, scoring_settings_after_create)

        crud.put_fantasy_league_scoring_settings(updated_scoring_settings)
        scoring_settings_after_update = crud.get_fantasy_league_scoring_settings_by_id(
            scoring_settings.fantasy_league_id
        )
    ...
    def test_get_fantasy_league_scoring_settings_by_id(self):
        ...
        self.assertEqual(
            scoring_settings,
            crud.get_fantasy_league_scoring_settings_by_id(scoring_settings.fantasy_league_id)
        )
        self.assertIsNone(crud.get_fantasy_league_scoring_settings_by_id(FantasyLeagueID("123")))
    ...
    def test_update_fantasy_league_settings_assertion_error(self):
        ...
        with self.assertRaises(AssertionError):
            crud.update_fantasy_league_settings(FantasyLeagueID("123"), fantasy_league_settings)
    ...
    def test_update_fantasy_league_status(self):
        ...
        updated_fantasy_league = crud.update_fantasy_league_status(fantasy_league.id, new_status)
        self.assertEqual(expected_updated_fantasy_league, updated_fantasy_league)
        with self.assertRaises(AssertionError):
            crud.update_fantasy_league_status(FantasyLeagueID("123"), new_status)
    ...
    def test_update_fantasy_league_current_draft_position(self):
        ...
        updated_fantasy_league = crud.update_fantasy_league_current_draft_position(
            fantasy_league.id, new_current_draft_position
        )
        self.assertEqual(expected_updated_fantasy_league, updated_fantasy_league)
        with self.assertRaises(AssertionError):
            crud.update_fantasy_league_current_draft_position(
