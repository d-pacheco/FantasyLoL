...
class TestCrudFantasyTeam(FantasyLolTestBase):
    def test_create_fantasy_team(self):
        # Arrange
        fantasy_team = fantasy_fixtures.fantasy_team_week_1

        # act
        crud.put_fantasy_team(fantasy_team)

        # Assert
        users_fantasy_teams = crud.get_all_fantasy_teams_for_user(
    ...
    def test_update_fantasy_team(self):
        ...
        # act
        crud.put_fantasy_team(modified_team)
    ...
    def test_get_all_fantasy_teams_for_user(self):
        ...
        crud.put_fantasy_team(fantasy_team_week_1)
        fantasy_team_week_2 = fantasy_fixtures.fantasy_team_week_2
        crud.put_fantasy_team(fantasy_team_week_2)
    ...
    def test_get_all_fantasy_teams_for_week(self):
        ...
        week_1_fantasy_teams = crud.get_all_fantasy_teams_for_week(fantasy_league.id, 1)
        self.assertEqual(1, len(week_1_fantasy_teams))
        self.assertEqual(fantasy_team_week_1, week_1_fantasy_teams[0])

        week_2_fantasy_teams = crud.get_all_fantasy_teams_for_week(fantasy_league.id, 2)
        self.assertEqual(1, len(week_1_fantasy_teams))
